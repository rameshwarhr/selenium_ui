...
public class updated_utility {

	public static DataFormatter dataFormatter = new DataFormatter();

	public static void main(String[] args) throws IOException {
		String inputFilePath = "C:\\Users\\user2\\Desktop\\Excel_Utility\\updated_templetee.xlsx"; // Replace with the
																									// path to your
																									// Excel file
		String outputFilePath = "C:\\Users\\user2\\Desktop\\Excel_Utility\\update_entity.txt"; // Replace with the
																								// desired path for the
																								// output text file
		...
		for (int i = 3; i <= rowLast; i++) {
			...
			if (isFirstLoop) {
				writer.newLine(); // Add a blank line after the first loop
				isFirstLoop = false; // Set the flag to false after the first loop
			}
			writer.newLine();
